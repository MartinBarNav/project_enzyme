...
public class ActionBarContainer extends FrameLayout
{
    ...
    public ActionBarContainer(final Context context, final AttributeSet set) {
        ...
        if (android.support.v7.internal.a.a()) {
            backgroundDrawable = new c(this);
        }
        else {
            backgroundDrawable = new b(this);
        }
        this.setBackgroundDrawable((Drawable)backgroundDrawable);
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, android.support.v7.b.a.i.ActionBar);
        this.a = obtainStyledAttributes.getDrawable(android.support.v7.b.a.i.ActionBar_background);
        this.b = obtainStyledAttributes.getDrawable(android.support.v7.b.a.i.ActionBar_backgroundStacked);
        this.j = obtainStyledAttributes.getDimensionPixelSize(android.support.v7.b.a.i.ActionBar_height, -1);
        if (this.getId() == android.support.v7.b.a.e.split_action_bar) {
            this.d = true;
            this.c = obtainStyledAttributes.getDrawable(android.support.v7.b.a.i.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.h = this.findViewById(android.support.v7.b.a.e.action_bar);
        this.i = this.findViewById(android.support.v7.b.a.e.action_context_bar);
    }
    ...
    public void onMeasure(int n, int b) {
        ...
        if (this.h == null) {
            ...
            if (View$MeasureSpec.getMode(b) == Integer.MIN_VALUE) {
                measureSpec = b;
                if (this.j >= 0) {
                    measureSpec = View$MeasureSpec.makeMeasureSpec(Math.min(this.j, View$MeasureSpec.getSize(b)), Integer.MIN_VALUE);
                }
            }
        }
        ...
        if (this.h != null) {
            ...
            if (this.g != null && this.g.getVisibility() != 8 && b != 1073741824) {
                if (!a(this.h)) {
                    n = b(this.h);
                }
                else if (!a(this.i)) {
                ...
                this.setMeasuredDimension(this.getMeasuredWidth(), Math.min(n + b(this.g), b));
            }
        }
    }
    ...
    public void setTabContainer(final m g) {
        if (this.g != null) {
