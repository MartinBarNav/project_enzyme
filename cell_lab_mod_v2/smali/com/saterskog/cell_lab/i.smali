...
.method public final a(ZZ)V
    ...
    const-wide/high16 v4, 0x4028000000000000L    # 6.0 -> 12.0

    const-wide/high16 v6, 0x3fd0000000000000L    # 0.5 -> 0.25
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    const/16 v0, 0x14  # loop counter (21)
    const/4 v2, 0x0   # starting number (0)
    const/4 v9, 0x1

    :fill_loop
    if-ge v2, v0, :add_infinity  # if v2 >= v0, exit loop
...
.method public final onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    .line 1499
    const-wide/high16 v4, 0x4010000000000000L    # 2.0 -> 4.0
    ...
    const-wide/high16 v8, 0x4010000000000000L    # 2.0 -> 4.0
