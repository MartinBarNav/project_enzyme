...
public class e<K, V> {
    ...
    private void a(int r4) {
        ...
        L_0x0000:
            monitor-enter(r3)
            int r0 = r3.b     // Catch:{ all -> 0x0032 }
            if (r0 < 0) goto L_0x0011
            java.util.LinkedHashMap<K, V> r0 = r3.a     // Catch:{ all -> 0x0032 }
        ...
        L_0x0043:
            ...
            int r0 = r3.e     // Catch:{ all -> 0x0032 }
            int r0 = r0 + 1
            r3.e = r0     // Catch:{ all -> 0x0032 }
            monitor-exit(r3)     // Catch:{ all -> 0x0032 }
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.e.e.a(int):void");
    }
